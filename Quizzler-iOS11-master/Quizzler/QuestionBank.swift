...
class QuestionBank {
    ...
    //Stores Questions in the list which has the format Question and correct answer (known through question classes constructor).
    var list = [Question]()
    
    init() {
        // Creating a quiz item and appending it to the list
        // Calling the classes constructor to intialize its valuse and store into the list
